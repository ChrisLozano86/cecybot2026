...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-03-2026 a las 20:34:30
...
CREATE TABLE `registro` (
  ...
  `verficado` enum('SI','NO') NOT NULL DEFAULT 'NO'
...
(1, 'Christian', 'Lozano', 'christian.lozanoh', 'Cecyte2026', '1', NULL, '1'),
(3, 'José Fernando ', 'Cervantes Rosas', 'jose.cervantesr', 'Cecyte2026', '1', NULL, '1');
