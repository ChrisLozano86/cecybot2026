...
<html lang="es">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <p style="padding: 20px;">Para recuperar tu comprobante de registro, ingresa el correo electrónico con el que registraste tu equipo. Si tienes dudas, puedes contactarnos al correo electrónico: <br> jose.cervantesr@cecyteg.edu.mx  christian.lozanoh@cecyteg.edu.mx</p>
...
<div class="cecybot-sidepanel">
  ...
  <a href="https://drive.google.com/file/d/1w8NfAmpgpBeW5JbE1lmpIHfd3IKO_7A3/view?usp=drive_link" target="_blank" class="btn btn-primary btn-lg">
    ...
    DESCARGAR LA CONVOCATORIA CECYBOT 2026
     ...
     <a href="#" class="btn btn-warning btn-la" data-bs-toggle="modal" data-bs-target="#modalRecuperar">RECUPERAR COMPROBANTE DE REGISTRO</a>
        ...
        <div class="row text-center my-4">
          ...
          <a href="https://drive.google.com/file/d/1EcDPKqVyci5O8tLuyCCfkt7lBdb2HKKM/view?usp=drive_link" target="_blank" class="card-link">
            <div class="card">
          ...
          <div class="col-12 col-md">
          <a href="https://drive.google.com/file/d/1yI-TJ3cfPVfyXUqZil30tY5M-PARQc7S/view?usp=drive_link" target="_blank" class="card-link">
            <div class="card">
         ...
         <!--  <div class="col-12 col-md">
          ...
          <div class="col-12 col-md">
          <a href="https://drive.google.com/file/d/14aGdOOEFjzUlkf3uJujDrgMDjdMG870N/view?usp=drive_link" target="_blank" class="card-link">
            <div class="card">
          ...
          <div class="col-12 col-md">
          <a href="https://drive.google.com/file/d/107nUMGQy2gDWgb2mwicZFfWaEnwX6frI/view?usp=drive_link" target="_blank" class="card-link">
            <div class="card">
